const CACHE='novel-cleaner-pwa-v14';
const STATIC=[
  './','./index.html','./app.css','./enhancements.css','./app.js','./src/main.js','./src/state.js','./src/clean-flow.js','./src/rules-ui.js','./src/github-sync.js','./src/learning-policy.js','./cleaner-core.js','./ad-pinyin-overlay.js','./worker.js',
